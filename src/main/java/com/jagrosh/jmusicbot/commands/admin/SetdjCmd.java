...
public class SetdjCmd extends AdminCommand
{
    ...
    protected void execute(CommandEvent event) 
    {
        ...
        {
            s.setDJRole(null);
            event.reply(event.getClient().getSuccess()+" DJ 역할이 지워졌습니다. 관리자 만 DJ 명령을 사용할 수 있습니다.");
        }
        else
        {
            ...
            else
            {
                ...
                event.reply(event.getClient().getSuccess()+" 사용자는 이제 DJ 명령을 사용할 수 있습니다. **"+list.get(0).getName()+"** 룰.");
            }
        }
    }
